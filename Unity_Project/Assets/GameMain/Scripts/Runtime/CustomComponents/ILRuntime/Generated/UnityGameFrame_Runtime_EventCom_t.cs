...
{
    unsafe class UnityGameFrame_Runtime_EventComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityGameFrame.Runtime.EventComponent);
        ...
        static StackObject* Subscribe_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityGameFrame.Runtime.EventComponent instance_of_this_method = (UnityGameFrame.Runtime.EventComponent)typeof(UnityGameFrame.Runtime.EventComponent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            instance_of_this_method.Subscribe(@eventId, @handler);
        ...
        static StackObject* Unsubscribe_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            instance_of_this_method.Unsubscribe(@eventId, @handler);
