...
{
    unsafe class UnityGameFrame_Runtime_EntityLogic_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityGameFrame.Runtime.EntityLogic);
            args = new Type[]{};
            method = type.GetMethod("get_IsAvailable", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_IsAvailable_0);
            args = new Type[]{};
        ...
        static StackObject* get_IsAvailable_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityGameFrame.Runtime.EntityLogic instance_of_this_method = (UnityGameFrame.Runtime.EntityLogic)typeof(UnityGameFrame.Runtime.EntityLogic).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            var result_of_this_method = instance_of_this_method.IsAvailable;
