...
{
    unsafe class Game_Runtime_DRScene_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Game.Runtime.DRScene);
            args = new Type[]{};
        ...
        static StackObject* get_AssetName_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Game.Runtime.DRScene instance_of_this_method = (Game.Runtime.DRScene)typeof(Game.Runtime.DRScene).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
