...
{
    unsafe class Game_Runtime_DRThruster_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Game.Runtime.DRThruster);
            args = new Type[]{};
        ...
        static StackObject* get_Speed_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Game.Runtime.DRThruster instance_of_this_method = (Game.Runtime.DRThruster)typeof(Game.Runtime.DRThruster).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
