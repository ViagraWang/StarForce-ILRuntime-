...
namespace ILRuntime.Runtime.Generated
{
    unsafe class GameFramework_Fsm_IFsm_1_IProcedureManager_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(UnityGameFramework.Runtime.VarInt)};
        ...
        static StackObject* SetData_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            UnityGameFramework.Runtime.VarInt @data = (UnityGameFramework.Runtime.VarInt)typeof(UnityGameFramework.Runtime.VarInt).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ...
            instance_of_this_method.SetData<UnityGameFramework.Runtime.VarInt>(@name, @data);
