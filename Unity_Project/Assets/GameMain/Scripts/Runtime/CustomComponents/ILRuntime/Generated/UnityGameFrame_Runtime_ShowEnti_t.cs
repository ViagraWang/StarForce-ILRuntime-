...
{
    unsafe class UnityGameFrame_Runtime_ShowEntitySuccessEventArgs_Binding
    {
        ...
        static StackObject* get_UserData_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityGameFrame.Runtime.ShowEntitySuccessEventArgs instance_of_this_method = (UnityGameFrame.Runtime.ShowEntitySuccessEventArgs)typeof(UnityGameFrame.Runtime.ShowEntitySuccessEventArgs).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        {
            return UnityGameFrame.Runtime.ShowEntitySuccessEventArgs.EventId;
        }
