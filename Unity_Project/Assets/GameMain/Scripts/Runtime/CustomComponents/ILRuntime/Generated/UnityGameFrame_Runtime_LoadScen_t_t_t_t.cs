...
{
    unsafe class UnityGameFrame_Runtime_LoadSceneDependencyAssetEventArgs_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(UnityGameFrame.Runtime.LoadSceneDependencyAssetEventArgs);
            args = new Type[]{};
        ...
        static StackObject* get_UserData_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityGameFrame.Runtime.LoadSceneDependencyAssetEventArgs instance_of_this_method = (UnityGameFrame.Runtime.LoadSceneDependencyAssetEventArgs)typeof(UnityGameFrame.Runtime.LoadSceneDependencyAssetEventArgs).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        {
            return UnityGameFrame.Runtime.LoadSceneDependencyAssetEventArgs.EventId;
        }
