...
{
    unsafe class Game_Runtime_ReferenceCollector_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Game.Runtime.ReferenceCollector);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, get_ComponentView_1);
            ...
            app.RegisterCLRMethodRedirection(method, get_CachedGameObject_3);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("GetGO", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetGO_4);
        ...
        static StackObject* get_CachedTransform_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Game.Runtime.ReferenceCollector instance_of_this_method = (Game.Runtime.ReferenceCollector)typeof(Game.Runtime.ReferenceCollector).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* get_ComponentView_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_CachedGameObject_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* GetGO_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
