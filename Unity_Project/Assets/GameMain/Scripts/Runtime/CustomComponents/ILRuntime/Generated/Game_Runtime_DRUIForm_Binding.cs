...
{
    unsafe class Game_Runtime_DRUIForm_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Game.Runtime.DRUIForm);
            args = new Type[]{};
        ...
        static StackObject* get_AssetName_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Game.Runtime.DRUIForm instance_of_this_method = (Game.Runtime.DRUIForm)typeof(Game.Runtime.DRUIForm).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
