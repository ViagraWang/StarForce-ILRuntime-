...
{
    unsafe class Game_Runtime_HotEntity_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Game.Runtime.HotEntity);
            args = new Type[]{};
        ...
        static StackObject* get_HotLogicInstance_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Game.Runtime.HotEntity instance_of_this_method = (Game.Runtime.HotEntity)typeof(Game.Runtime.HotEntity).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
