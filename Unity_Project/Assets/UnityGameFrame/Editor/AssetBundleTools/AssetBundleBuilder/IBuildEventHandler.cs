...
namespace UnityGameFrame.Editor.AssetBundleTools
{
    ...
    public interface IBuildEventHandler
    {
        ...
        void OnHandleVersionList(string path, string latestGameVersion, int internalResourceVersion, int versionListLength, int versionListHashCode, int versionListZipLength, int versionListZipHashCode);
