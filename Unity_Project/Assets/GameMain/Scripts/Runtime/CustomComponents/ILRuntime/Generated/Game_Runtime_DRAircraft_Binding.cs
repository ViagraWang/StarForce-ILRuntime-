...
{
    unsafe class Game_Runtime_DRAircraft_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Game.Runtime.DRAircraft);
            args = new Type[]{};
        ...
        static StackObject* get_ThrusterId_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Game.Runtime.DRAircraft instance_of_this_method = (Game.Runtime.DRAircraft)typeof(Game.Runtime.DRAircraft).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
