...
namespace ILRuntime.Runtime.Generated
{
    unsafe class GameFramework_DataTable_IDataTable_1_DRThruster_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(GameFramework.DataTable.IDataTable<Game.Runtime.DRThruster>);
        ...
        static StackObject* GetDataRow_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            GameFramework.DataTable.IDataTable<Game.Runtime.DRThruster> instance_of_this_method = (GameFramework.DataTable.IDataTable<Game.Runtime.DRThruster>)typeof(GameFramework.DataTable.IDataTable<Game.Runtime.DRThruster>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
