...
{
    unsafe class Game_Runtime_HotLog_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Game.Runtime.HotLog);
        ...
        static StackObject* Warning_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Game.Runtime.HotLog.Warning(@message);
        ...
        static StackObject* Info_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Game.Runtime.HotLog.Info(@message);
        ...
        static StackObject* Error_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Game.Runtime.HotLog.Error(@message);
        ...
        static StackObject* Error_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Game.Runtime.HotLog.Error(@format, @args);
        ...
        static StackObject* Debug_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Game.Runtime.HotLog.Debug(@message);
        ...
        static StackObject* Warning_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Game.Runtime.HotLog.Warning(@format, @args);
        ...
        static StackObject* Info_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Game.Runtime.HotLog.Info(@format, @args);
